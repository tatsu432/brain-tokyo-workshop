...
class CartPoleSwingUpEnv(gym.Env):
    ...
    def render(self, mode="human", close=False):
        ...
        pygame.draw.line(
            self.viewer, (0, 0, 0), (track_left, track_y), (track_right, track_y), 2
        )
        ...
        # Draw axle
        pygame.draw.circle(
            self.viewer, (25, 255, 255), (cartx, carty_int), int(polewidth / 2)
        )

        # Draw pole bob
        pygame.draw.circle(
            self.viewer, (0, 0, 0), (pole_end_x, pole_end_y), int(polewidth / 2)
        )
