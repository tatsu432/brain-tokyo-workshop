...
vae_racing_stack = Game(
    env_name="VAERacingStack-v0",
...
L = [list(range(1, classify.input_size)), list(range(0, classify.output_size))]
...
L = [list(range(1, mnist784.input_size)), list(range(0, mnist784.output_size))]
label = [item for sublist in L for item in sublist]
...
L = [list(range(1, mnist256.input_size)), list(range(0, mnist256.output_size))]
label = [item for sublist in L for item in sublist]
...
slimevolley_shaped_curriculum = slimevolley._replace(
...
slimevolley_selfplay_no_curriculum = slimevolley._replace(
