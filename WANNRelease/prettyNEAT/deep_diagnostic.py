...
try:
    ...
    print(f"  Output 0 range: [{all_outputs[:,0].min():.3f}, {all_outputs[:,0].max():.3f}]")
    print(f"  Output 1 range: [{all_outputs[:,1].min():.3f}, {all_outputs[:,1].max():.3f}]")
...
try:
    ...
    print(f"  Output 0: range=[{raw_outputs[:,0].min():.3f}, {raw_outputs[:,0].max():.3f}], "
          f"mean={raw_outputs[:,0].mean():.3f}")
    print(f"  Output 1: range=[{raw_outputs[:,1].min():.3f}, {raw_outputs[:,1].max():.3f}], "
